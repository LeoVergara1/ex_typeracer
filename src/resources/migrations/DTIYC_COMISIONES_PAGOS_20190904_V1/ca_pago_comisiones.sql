...
create or replace PACKAGE        genpub.pc_pago_comisiones AS
  ...
  PROCEDURE pr_comisiones_li(p_fecha_pago_ini IN DATE, p_fecha_pago_fin IN DATE, p_campus IN VARCHAR2, out_comisiones OUT sys_refcursor);
...
create or replace PACKAGE BODY        genpub.pc_pago_comisiones AS
  ...
  FUNCTION fn_monto_descuentos (p_pidm IN NUMBER, p_periodo IN VARCHAR2)RETURN NUMBER AS
    ...
    END pr_comisiones;
        ...
        PROCEDURE pr_comisiones_li(p_fecha_pago_ini IN DATE, p_fecha_pago_fin IN DATE, p_campus IN VARCHAR2, out_comisiones out sys_refcursor) AS
    v_consulta VARCHAR2(20000);
