...
REM Realizado por: VMRB, 3  de Diciembre  de 2019
*/


DROP TABLE COMISIONLI.admin_de_comisiones;
DROP TABLE COMISIONLI.autorizacion_comisiones;
DROP TABLE COMISIONLI.asociacion_promotor;
DROP TABLE COMISIONLI.authorization_crescent;
DROP TABLE COMISIONLI.campaign;
DROP TABLE COMISIONLI.goal;
DROP TABLE COMISIONLI.mail_comisiones;
DROP TABLE COMISIONLI.program_manager;
DROP TABLE COMISIONLI.trimester;
DROP TABLE COMISIONLI.user_campus;
DROP TABLE COMISIONLI.relacion_campus;
DROP TABLE COMISIONLI.SICOSS;
DROP SEQUENCE "COMISIONLI"."SQ_ID_TRIMESTER";
DROP SEQUENCE "COMISIONLI"."SQ_ID_GOAL";
DROP SEQUENCE "COMISIONLI"."SQ_ID_CAMPAIGN";
DROP SEQUENCE "COMISIONLI"."SQ_ID_AUTHORIZATION_CRESCENT";
DROP SEQUENCE "COMISIONLI"."SQ_ID_SICOSS";
...
ALTER TABLE COMISIONLI.AUTORIZACION_COMISIONES ADD ID_COORDINADOR VARCHAR2(255);
ALTER TABLE COMISIONLI.AUTORIZACION_COMISIONES ADD USUARIO VARCHAR2(255);
ALTER TABLE COMISIONLI.AUTORIZACION_COMISIONES ADD NOMBRE_COORDINADOR VARCHAR2(255);
ALTER TABLE COMISIONLI.AUTORIZACION_COMISIONES ADD FECHA_AUTORIZADO DATE;
ALTER TABLE COMISIONLI.AUTORIZACION_COMISIONES ADD COMISION_COORDINADOR NUMBER;
