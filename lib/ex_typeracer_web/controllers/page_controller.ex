defmodule ExTyperacerWeb.PageController do
  ...
  def new_user(conn, params) do
    ...
    Repo.insert %Person{name: params["person"]["name"], lastname: params["person"]["lastname"], email: params["person"]["email"], password: params["person"]["password"], username: params["person"]["username"]}
    render conn, "index.html" 
  end
end
